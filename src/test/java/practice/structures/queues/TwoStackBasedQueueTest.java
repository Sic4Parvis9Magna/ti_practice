...
class TwoStackBasedQueueTest {
    ...
    @BeforeEach
    void setUp() {
        myQueue1 = new TwoStackBasedQueue<>(3);
        myQueue1.offer(str1);
        myQueue1.offer(str2);
        myQueue1.offer(str3);
        myQueue2 = new TwoStackBasedQueue<>(6);
        myQueue2.offer(str1);
        myQueue2.offer(str2);
        myQueue2.offer(str3);
    }
    ...
    void peek() {
        assertThat(myQueue2.peek().isPresent(), is(true));
        assertThat(myQueue2.peek().get(), is("One"));
